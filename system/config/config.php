...
$config->methodVar   = 'a';               // RequestType=GET: the name of the method var.
...
define('TABLE_TUAN',           $config->db->prefix . 'tuan');
define('TABLE_SHOP',           $config->db->prefix . 'shop');
define('TABLE_SECONDHAND',     $config->db->prefix . 'secondhand');
define('TABLE_LOG',            $config->db->prefix . 'log');
define('TABLE_CONTENTS',       $config->db->prefix . 'contents');
